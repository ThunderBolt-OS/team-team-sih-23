...
const Section2 = () => {
	...
	return (
		<Paper
			...
			ref={containerRef}
		>
			<Typography sx={{ my: 2 }}>Page 1 of 1</Typography>
			...
			{data?.map((officer, index) => (
				...
				>
					<Paper
						...
						elevation={5}
						sx={{
							overflow: 'auto', p: 1, mb: 1,
							// border: '1px solid lightgrey', 
							// borderRadius: '5px',
							// borderWidth: '2px',
							borderRadius: '5px',
							bgcolor: '#f4f4f4',
							border: `1px solid ${officerLocationFromId[officer.id].isPointInsidePolygon ? theme.palette.success['600'] : theme.palette.error.light}`
							// + officerLocationFromId[officer.id].isPointInsidePolygon ? theme.palette.success.light : theme.palette.error.light,
						}}
					>
						<Grid
							container
